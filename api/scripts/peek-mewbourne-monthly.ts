/**
 * Diagnostic for PDSWDX-MP-mewbourne-MONTHLY.pdf. Discovers column layout
 * before wiring a parser. Mirrors peek-mewbourne-daily.ts.
 */
...
const FILE = 'PDSWDX-MP-mewbourne-MONTHLY.pdf';
